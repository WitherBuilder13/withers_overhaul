...
public class BroccoliBlock extends CropBlock {
    public static final MapCodec<BroccoliBlock> CODEC = createCodec(BroccoliBlock::new);
    private static final VoxelShape[] SHAPES_BY_AGE = Block.createShapeArray(7, age -> Block.createColumnShape(16.0, 0.0, 2 + age));

    public MapCodec<BroccoliBlock> getCodec() {
        return CODEC;
    }

    public BroccoliBlock(Settings settings) {
        super(settings);
    }

    @Override
    protected ItemConvertible getSeedsItem() {
        return BlockItems.BROCCOLI;
    }
