...
public class RadishesBlock extends CropBlock {
    public static final MapCodec<RadishesBlock> CODEC = createCodec(RadishesBlock::new);
    private static final VoxelShape[] SHAPES_BY_AGE = Block.createShapeArray(7, age -> Block.createColumnShape(16.0, 0.0, 2 + age));

    public MapCodec<RadishesBlock> getCodec() {
        return CODEC;
    }

    public RadishesBlock(Settings settings) {
        super(settings);
    }

    @Override
    protected ItemConvertible getSeedsItem() {
        return BlockItems.RADISH;
    }
