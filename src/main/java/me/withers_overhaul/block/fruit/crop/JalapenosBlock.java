...
public class JalapenosBlock extends CropBlock {
    public static final MapCodec<JalapenosBlock> CODEC = createCodec(JalapenosBlock::new);
    private static final VoxelShape[] SHAPES_BY_AGE = Block.createShapeArray(7, age -> Block.createColumnShape(16.0, 0.0, 2 + age));

    public MapCodec<JalapenosBlock> getCodec() {
        return CODEC;
    }

    public JalapenosBlock(Settings settings) {
        super(settings);
    }

    @Override
    protected ItemConvertible getSeedsItem() {
        return BlockItems.JALAPENO;
    }
