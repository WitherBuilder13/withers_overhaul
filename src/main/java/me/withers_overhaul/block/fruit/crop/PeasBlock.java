...
public class PeasBlock extends CropBlock {
    public static final MapCodec<PeasBlock> CODEC = createCodec(PeasBlock::new);
    private static final VoxelShape[] SHAPES_BY_AGE = Block.createShapeArray(7, age -> Block.createColumnShape(16.0, 0.0, 2 + age));

    public MapCodec<PeasBlock> getCodec() {
        return CODEC;
    }

    public PeasBlock(Settings settings) {
        super(settings);
    }

    @Override
    protected ItemConvertible getSeedsItem() {
        return BlockItems.PEAS;
    }
