...
public class CantaloupeBlock extends CropBlock {
    public static final MapCodec<CantaloupeBlock> CODEC = createCodec(CantaloupeBlock::new);
    private static final VoxelShape[] SHAPES_BY_AGE = Block.createShapeArray(7, age -> Block.createColumnShape(16.0, 0.0, 2 + age));

    public MapCodec<CantaloupeBlock> getCodec() {
        return CODEC;
    }
