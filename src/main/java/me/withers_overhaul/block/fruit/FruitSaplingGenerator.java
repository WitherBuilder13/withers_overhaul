...
public class FruitSaplingGenerator {
    ...
    private final Optional<RegistryKey<ConfiguredFeature<?, ?>>> defaultFancyTreeConfiguredFeature;
    private final Optional<List<RegistryKey<ConfiguredFeature<?, ?>>>> fancyFruitTreeConfiguredFeatures;
    ...
    public FruitSaplingGenerator(
            ...
            Optional<RegistryKey<ConfiguredFeature<?, ?>>> defaultFancyTreeConfiguredFeature,
            Optional<List<RegistryKey<ConfiguredFeature<?, ?>>>> fancyFruitTreeConfiguredFeatures
    ) {
        this.id = id;
        ...
        this.defaultFancyTreeConfiguredFeature = defaultFancyTreeConfiguredFeature;
        this.fancyFruitTreeConfiguredFeatures = fancyFruitTreeConfiguredFeatures;
    }

    private RegistryKey<ConfiguredFeature<?, ?>> getDefaultTreeConfiguredFeature() {
        return this.defaultTreeConfiguredFeature;
    }

    private RegistryKey<ConfiguredFeature<?, ?>> getFruitTreeConfiguredFeature(int index) {
        if (index >= this.fruitTreeConfiguredFeatures.size()) return null;
        return this.fruitTreeConfiguredFeatures.get(index);
    }

    @Nullable
    private RegistryKey<ConfiguredFeature<?, ?>> getDefaultFancyTreeConfiguredFeature() {
        return this.defaultFancyTreeConfiguredFeature.orElse(null);
    }

    @Nullable
    private RegistryKey<ConfiguredFeature<?, ?>> getFancyFruitTreeConfiguredFeature(int index) {
        if (index >= this.fancyFruitTreeConfiguredFeatures.orElse(List.of()).size()) return null;
        return this.fancyFruitTreeConfiguredFeatures.orElse(List.of()).get(index);
    }

    public boolean generate(ServerWorld world, ChunkGenerator chunkGenerator, BlockPos pos, BlockState state, Random random) {

        RegistryKey<ConfiguredFeature<?, ?>> defaultTreeKey = this.getDefaultTreeConfiguredFeature();
        ...
        if (fruitEnum.equals(TreeFruit.Temperate.class)) {
            RegistryKey<ConfiguredFeature<?, ?>> appleTreeKey = this.getFruitTreeConfiguredFeature(0);
            RegistryKey<ConfiguredFeature<?, ?>> apricotTreeKey = this.getFruitTreeConfiguredFeature(1);
            RegistryKey<ConfiguredFeature<?, ?>> kiwiTreeKey = this.getFruitTreeConfiguredFeature(2);
            RegistryKey<ConfiguredFeature<?, ?>> nectarineTreeKey = this.getFruitTreeConfiguredFeature(3);
            RegistryKey<ConfiguredFeature<?, ?>> peachTreeKey = this.getFruitTreeConfiguredFeature(4);
            RegistryKey<ConfiguredFeature<?, ?>> pearTreeKey = this.getFruitTreeConfiguredFeature(5);
            RegistryKey<ConfiguredFeature<?, ?>> plumTreeKey = this.getFruitTreeConfiguredFeature(6);
            ...
            RegistryKey<ConfiguredFeature<?, ?>> kumquatTreeKey = this.getFruitTreeConfiguredFeature(0);
            RegistryKey<ConfiguredFeature<?, ?>> oliveTreeKey = this.getFruitTreeConfiguredFeature(1);
            RegistryKey<ConfiguredFeature<?, ?>> persimmonTreeKey = this.getFruitTreeConfiguredFeature(2);
            RegistryKey<ConfiguredFeature<?, ?>> pomegranateTreeKey = this.getFruitTreeConfiguredFeature(3);
            ...
            RegistryKey<ConfiguredFeature<?, ?>> cherryTreeKey = this.getFruitTreeConfiguredFeature(0);
            RegistryKey<ConfiguredFeature<?, ?>> figTreeKey = this.getFruitTreeConfiguredFeature(1);
            RegistryKey<ConfiguredFeature<?, ?>> grapefruitTreeKey = this.getFruitTreeConfiguredFeature(2);
            RegistryKey<ConfiguredFeature<?, ?>> guavaTreeKey = this.getFruitTreeConfiguredFeature(3);
            RegistryKey<ConfiguredFeature<?, ?>> tangerineTreeKey = this.getFruitTreeConfiguredFeature(4);
            ...
            RegistryKey<ConfiguredFeature<?, ?>> avocadoTreeKey = this.getFruitTreeConfiguredFeature(0);
            RegistryKey<ConfiguredFeature<?, ?>> bananaTreeKey = this.getFruitTreeConfiguredFeature(1);
            RegistryKey<ConfiguredFeature<?, ?>> lemonTreeKey = this.getFruitTreeConfiguredFeature(2);
            RegistryKey<ConfiguredFeature<?, ?>> limeTreeKey = this.getFruitTreeConfiguredFeature(3);
            RegistryKey<ConfiguredFeature<?, ?>> mangoTreeKey = this.getFruitTreeConfiguredFeature(4);
            RegistryKey<ConfiguredFeature<?, ?>> orangeTreeKey = this.getFruitTreeConfiguredFeature(5);
            RegistryKey<ConfiguredFeature<?, ?>> starfruitTreeKey = this.getFruitTreeConfiguredFeature(6);
