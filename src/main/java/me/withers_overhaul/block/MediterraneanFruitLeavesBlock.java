...
public class MediterraneanFruitLeavesBlock extends LeavesBlock {
    public final EnumProperty<TreeFruit.Mediterranean> FRUIT = EnumProperty.of("fruit", TreeFruit.Mediterranean.class);
    ...
    @Override
    public MapCodec<MediterraneanFruitLeavesBlock> getCodec() {
        return CODEC;
    }

    public MediterraneanFruitLeavesBlock(float leafParticleChance, Settings settings) {
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        if (state.get(FRUIT) != TreeFruit.Mediterranean.NONE) {
