...
public class BiomeTagGen extends VanillaBiomeTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        getOrCreateTagBuilder(TEMPERATURE_TEMPERATE).add(
                PLAINS, SUNFLOWER_PLAINS, FOREST, FLOWER_FOREST, MEADOW, DARK_FOREST, /*EBONY_THICKET,*/ CLOUD_FOREST,
        ...
        getOrCreateTagBuilder(TEMPERATURE_HOT).add(
                DESERT, DESERT_FIELDS, /*GRASSLANDS,*/ SPARSE_JUNGLE, JUNGLE, TROPICAL_RAINFOREST, BADLANDS, WOODED_BADLANDS, BAMBOO_JUNGLE, MONSOON_RAINFOREST,
